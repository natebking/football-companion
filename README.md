...
- [Next live-analysis pass](docs/LIVE-ANALYSIS-NEXT-PASS-2026-09-06.md): current product gaps, a bounded broadcast comparison and linked post-play explanations (planned).
